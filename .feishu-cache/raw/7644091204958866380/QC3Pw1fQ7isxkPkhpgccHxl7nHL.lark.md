...
<whiteboard token="KvKRwYpt9hJBLjbv96scP6kmnVc"></whiteboard>
...
<whiteboard token="KahGwyiwnhkxFRbMUTYcW3SOn2e"></whiteboard>
...
- 「agent-teams.md」 — 多智能体并行协调
- 「iterative-refinement.md」 — 核心提示-观察-再提示循环
- 「plan-driven.md」 — 执行前先规划
- ../../examples/agents/ — 即用型智能体模板