...
> **置信度**：第一级——Anthropic 官方文档**阅读时间**：约 15 分钟**范围**：理解和配置 Claude Code 的原生进程级沙箱**最后更新**：2026-02-02
...
<whiteboard token="Sdx7wSTPAhA896bQbtbc0GYpn7e"></whiteboard>
...
<whiteboard token="LDNzwhOk5hLRFFbl6nUcfqR0nOe"></whiteboard>
...
- 「沙箱隔离（Docker、云端）」 - 基于 microVM 的最高隔离沙箱
- 「架构：权限模型」 - 权限与沙箱如何交互
