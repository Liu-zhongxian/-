...
console.log(`已生成 <equation>{outDir}/CLAUDE.md（</equation>{modules.length} 个模块）`);
...
> 来源：飞书 · AI Spark 知识库 ｜ 原文（最新版）：<https://lcnniolukk80.feishu.cn/wiki/AyDzwUyEpi7e6ok4vkDccGfTn1g> ｜ 归档：2026-05-29
