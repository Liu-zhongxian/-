...
自媒体缺素材，用 Codex APP 或 Claude Code 调 HyperFrames by HeyGen，本地 10 分钟出一条 1080×1920 / 30 秒 / 30fps 成片，全程不依赖云端。[→ 打开完整全文](https://lcnniolukk80.feishu.cn/wiki/VBmUwo60IiYeDDkbAaZciEiPnYe)
...
| 延伸阅读 | [02.2｜AI 工具教程 → Claude Code 安装教程](https://lcnniolukk80.feishu.cn/wiki/KWlzwKCPIix1rbkd1GYc9FEwnLc) |
