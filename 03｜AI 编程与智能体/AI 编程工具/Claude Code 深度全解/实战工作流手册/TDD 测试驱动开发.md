...
> **更进一步**：JiTTesting 在 PR 时自动应用变异测试——由 LLM 生成，短暂存在，零维护。Meta 大规模部署了这项技术，与传统测试相比回归捕获率提升了 4 倍。参见 [Meta 的即时捕获测试生成](https://arxiv.org/abs/2601.22832)和「方法论指南」，了解当今 Claude Code 的近似模式。
