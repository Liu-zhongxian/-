...
<whiteboard token="MGtlwga0RhUmUfbNejdc79BTnle"></whiteboard>

**核心洞见**：Perplexity 回答"我们应该构建什么？"→ Claude Code 回答"在这个项目里怎么构建？"

### 决策流程

<whiteboard token="C3q7wstZOhixcQbOYLYcwEsEngb"></whiteboard>
...
<whiteboard token="FXqkw55q3hiFulbJhkbcZ5BjnLc"></whiteboard>
...
<whiteboard token="F4I4wnN1Jh6BQBbcho5chRvXnNc"></whiteboard>
...
curl -fsSL "https://github.com/anthropics/anthropic-cli/releases/download/v${VERSION}/ant_<equation>{VERSION}_</equation>{OS}_${ARCH}.tar.gz" \
...
> 来源：飞书 · AI Spark 知识库 ｜ 原文（最新版）：<https://lcnniolukk80.feishu.cn/wiki/A7Nlw6lLLiGlRWkYfvzcZyX2nJg> ｜ 归档：2026-05-29
