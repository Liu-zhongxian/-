...
├─ 标准（功能、Bug）          → Sonnet 4.5/4.6  (<equation> — 最佳性价比)
└─ 复杂（架构、安全）
   ├─ 需要深度推理？           → Opus 4.7 (xhigh) / Opus 4.6  (</equation>$ — ~比 Sonnet 贵 5 倍)
...
- [速查手册](https://www.feishu.cn/wiki/JTcswthzfiKGvgkagT6cYNX9nke)